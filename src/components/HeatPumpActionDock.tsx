...
interface HeatPumpActionDockProps {
...
export function HeatPumpActionDock({ 
  onServiceRequest, 
  onEmergency,
  onMaintenanceTips,
  overallScore,
  hasActiveServices,
  isCritical,
}: HeatPumpActionDockProps) {
  
  const isServiceUrgent = overallScore < 70 && overallScore >= 40;
  ...
  const getButtonLabel = () => {
    ...
    return 'Contact Your Technician';
  };
  ...
  return (
    ...
    >
      ...
      <div className="max-w-md mx-auto">
        ...
        <Button
          onClick={() => {
            if (isHealthy && !hasActiveServices) {
              onMaintenanceTips();
            } else {
              onServiceRequest();
            }
